#!/usr/bin/env python3
"""
build_herma_report.py
=====================
Erstellt output/billing_report/herma_dinas_vergleich.xlsx im GEZE-Format:
  Sheet 1 "HERMA GmbH"     — 33-Spalten Cluster-Vergleich (alt/neu, ▶-Header)
  Sheet 2 "NK_Konditionen" — leer (NK-Datei ist .docx, manuelle Übertragung erforderlich)
"""
...
OUT_XLSX    = REPORT_DIR / 'herma_dinas_vergleich.xlsx'
...
def build_main_sheet(ws):
    ...
    wc(ws,1,1, f'HERMA GmbH ({KNR}) — Dinas PRE vs AX POST  |  '
...
def build_nk_sheet(ws):
    ...
    ws.cell(row=1, column=1).value = (
        'NK-Datei ist .docx — manuelle Übertragung erforderlich. '
        'Quelle: data/extracted/bi/Herma/Herma Konditionen/Herma Konditionen/'
        'Herma Etiketten/2026/20251212_Herma_Nebenkosten_2026-2028.docx'
    )
...
print(f'  Sheet "HERMA GmbH":      {last_row} Zeilen')
print(f'  Sheet "NK_Konditionen": leer (NK-Datei ist .docx)')
