#!/usr/bin/env python3
"""build_ssc_report.py — Sika Supply Center GmbH (KNR 511241), Stellplatz-basiert"""
...
def build_main_sheet(ws):
    ws.title = 'Sika Supply Center GmbH'
    ws.freeze_panes = 'A3'
    ws.merge_cells(start_row=1, start_column=1, end_row=1, end_column=N)
    wc(ws,1,1, f'Sika Supply Center GmbH ({KNR}) — Dinas PRE vs AX POST  |  '
